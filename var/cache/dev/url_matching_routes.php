...
return [
    false, // $matchHost
    [ // $staticRoutes
        '/categories' => [[['_route' => 'catalogueCategoriesPrincipales', '_controller' => 'App\\Controller\\CategorieController::catalogueCategoriesPrincipales'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        26 => [[['_route' => 'showCategorie', '_controller' => 'App\\Controller\\CategorieController::showCategorie'], ['id'], null, null, false, true, null]],
        48 => [[['_route' => 'showTopic', '_controller' => 'App\\Controller\\TopicController::showTopic'], ['id'], null, null, false, true, null]],
